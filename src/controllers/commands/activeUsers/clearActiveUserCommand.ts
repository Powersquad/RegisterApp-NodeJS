...
const attemptRemoveActiveUser = async (
    ...
    activeUserQuery: (
        lookupData: string,
        queryTransaction?: Sequelize.Transaction ) => Promise<ActiveUserModel | null> ): Promise<CommandResponse<void>> => {

            let removeTransaction: Sequelize.Tranaction;

            return DatabaseConnection.createTransaction()
                .then((createdTransaction: Sequelize.Tranaction): Promise<ActiveUserModel | null> =>{
                    ...
                    return queriedActiveUser.destroy(<Sequelize.DestroyOptions>{
